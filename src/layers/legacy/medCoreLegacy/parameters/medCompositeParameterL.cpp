...
medCompositeParameterL::medCompositeParameterL(QString name, QObject* parent):
        medAbstractParameterL(name, parent),
        d(new medCompositeParameterLPrivate)
{

}

medCompositeParameterL::~medCompositeParameterL()
{
    delete d;
}

QWidget* medCompositeParameterL::getWidget()
{
...
void medCompositeParameterL::setValues(const QHash<QString, QVariant> &value)
{
    ...
    while (valuesIterator != value.constEnd())
    {
        ...
        {
            if (!( d->variants[key] == valuesIterator.value()))
            {
                d->variants[key] = valuesIterator.value();
                valueUpdated = true;
            }
...
QList<QVariant> medCompositeParameterL::values() const
{
...
void medCompositeParameterL::addVariant(QString name, QVariant variant, QVariant min, QVariant max, QVariant step)
{
...
void medCompositeParameterL::updateValue(bool value)
{
...
void medCompositeParameterL::updateValue(double value)
{
...
void medCompositeParameterL::updateValue(int value)
{
...
QList<QPair<QVariant, QVariant> > medCompositeParameterL::ranges() const
{
    return d->ranges.values();
}

QList<QVariant> medCompositeParameterL::steps() const
{
    return d->steps.values();
}

void medCompositeParameterL::trigger()
{
    emit valuesChanged(d->variants);
}
